        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TellPhone = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ...
                    CEOCell = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    CEOFirstName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    CEOLastName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IndustryCompanies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IndustryCompanies_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IndustryCompanies_Industries_IndustryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Amount = table.Column<decimal>(type: "decimal(36,0)", precision: 36, scale: 0, nullable: false),
                    ResourceSize = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoleGroups_AspNetRoles_ApplicationRoleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountValue = table.Column<decimal>(type: "decimal(36,0)", precision: 36, scale: 0, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Licences_DiscountTypes_DiscountTypeId",
                        column: x => x.DiscountTypeId,
                        principalTable: "DiscountTypes",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Licences_Plans_PlanId",
                        column: x => x.PlanId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    OtpCode = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ...
                    OtpCodeVerified = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfBirth = table.Column<DateTime>(type: "datetime2", nullable: true),
                    OfficeTell = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    HomeTell = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IndustryCompanies_CompanyId",
                table: "IndustryCompanies",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_IndustryCompanies_IndustryId",
                table: "IndustryCompanies",
                column: "IndustryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Licences_DiscountTypeId",
                table: "Licences",
                column: "DiscountTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Licences_PlanId",
                table: "Licences",
                column: "PlanId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoleGroups_ApplicationRoleId",
                table: "RoleGroups",
